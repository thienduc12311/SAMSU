...
public class EventProposalResponse {
    ...
    public EventProposalResponse(EventProposal eventProposal){
        ...
        creator = new UserProfileReduce(eventProposal.getCreatorUserId().getName(), eventProposal.getCreatorUserId().getUsername(), eventProposal.getCreatorUserId().getAvatar(),eventProposal.getCreatorUserId().getRollnumber());
        if (eventProposal.getAccepterUserId() != null) {
            accepter = new UserProfileReduce(eventProposal.getAccepterUserId().getName(),eventProposal.getAccepterUserId().getUsername(), eventProposal.getAccepterUserId().getAvatar(), eventProposal.getCreatorUserId().getRollnumber());
        }
